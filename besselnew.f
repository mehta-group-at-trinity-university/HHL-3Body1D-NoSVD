...
!NB:  This is NOT the spherical bessel function jn(x), instead it is x*jn(x),
...
!CU    USES beschb
 ...
 11   continue
      write(6,*) "x = ", x, "... argument too large in bessjy."
      write(6,*) "try asymptotic expansion. (press enter to continue)"
      read(*,*)
1     continue
      rjl=isign*FPMIN
      rjpl=h*rjl
