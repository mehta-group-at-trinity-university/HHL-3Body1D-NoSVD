cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc      
      ...
      double precision Tol,TempShift,OldTempShift,MatchTol,Shift2,Rvalue
...
c     TempShift = AllEnergies(CurrentNumStates-1)
      ...
      do while ((CurrentNumStates .lt. NumStates) .AND. (iLoop .lt. 5))
         ...
         write(6,*) 'iLoop = ',iLoop, 'CurrentNumStates = ', CurrentNumStates
         info = 0
...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      subroutine CalcEigenErrorsNew(info,MatrixDim,H,S,HalfBandWidth,NumStates,Psi,Energies,MaxNumStates)
